...
class Options
{
 public:
    inline Options()
        : mFilenamesToIgnore("^(build|dist|\\.cabal.*|TAGS|.*\\.(html|docx?|xlsx?|o|py[oc]|git|gitignore|so[\\.0-9]*|a|dylib|libs|exe|ilk|obj|pch|pdb|idb|fasl)(\\.(bz2|gz|xz))?)$", std::regex::icase),
